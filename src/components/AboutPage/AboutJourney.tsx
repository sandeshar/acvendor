                ...
                <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative h-full min-h-[300px] w-full rounded-xl overflow-hidden shadow-xl group">
                            ...
                            <div className="h-full w-full bg-cover bg-center" data-alt={section?.hero_image_alt || 'Team of professionals'} style={{ backgroundImage: section?.hero_image ? `url("${section.hero_image}")` : `url("https://lh3.googleusercontent.com/aida-public/AB6AXuDda5biMwpMvtX_h7btShwaroEUJ1ijOwryycUDayNUEpgCs5Get0Ep6MoDB5u_3rw9c-R5gRyZWYnGqHuoiqBOTd3JUyVZuq0UUXI8R2BUjuY5HIq_-4V_ckfdOBetgRgNaf-rpTdE7AtC-rxH-KYR9y4D8oTpDqs_FSBTaaWChdJ0ilJKnKdEc2PzxxHoZixugfmxmKMdJ_Stnxg81KaJVzEjzoOwjuv-RFS4_nBIQkPZForGEXJHgs8q0H05VzwwvwgkkURRlMg")` }} />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4">
                        {stats && stats.length > 0 ? stats.map((s) => (
                            ...
                            // Defaults
                            <>
                                <StatCard value="5000+" label="Installations" />
                                <StatCard value="15+" label="Years Experience" />
                                <StatCard value="50+" label="Certified Techs" />
