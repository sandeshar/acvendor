...
export default function EditBlogPage() {
    ...
    const handleSubmit = async (e: React.FormEvent, isDraft: boolean = false) => {
        ...
        if (formData.slug && !isValidSlug(formData.slug)) {
            showToast('Please fix invalid slug format', { type: 'error' });
            return;
        }
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            className={`flex-1 px-4 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-primary focus:border-primary ${formData.slug && !isValidSlug(formData.slug) ? 'border-red-500' : 'border-slate-300'}`}
