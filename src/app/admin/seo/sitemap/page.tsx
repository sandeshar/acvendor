                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    disabled={generating}
                                    className="w-full bg-primary text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 font-medium hover:bg-primary/90 disabled:opacity-60"
                                >
                        ...
                        <div className="bg-primary-50 rounded-lg border border-primary-200 p-6">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-primary-900 mb-2">About Sitemaps</h3>
