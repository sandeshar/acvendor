        ...
        <main className="flex-1 w-full max-w-[1200px] mx-auto p-4 md:p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                    <h1 className="text-3xl md:text-4xl font-black leading-tight tracking-tight">Create New Quotation</h1>
                                ...
                                <tr key={idx} className="group hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="relative">
                                            ...
                                            <input type="number" value={it.unitPrice ?? 0} onChange={(e) => updateItem(idx, { unitPrice: Number(e.target.value) || 0 })} className="w-full rounded border border-gray-200 bg-white pl-5 pr-2 py-1.5 text-sm text-right" />
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="relative">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-end items-start md:items-end">
                ...
                <div className="w-full md:w-[400px] bg-white rounded-xl shadow-sm border border-[#f0f2f4] p-6 flex flex-col gap-4">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-black text-primary">${formatCurrency(totals.grandTotal)}</span>
                    </div>
