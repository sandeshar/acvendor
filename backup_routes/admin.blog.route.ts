...
// This file intentionally does not export route handlers to avoid conflicts with the existing page at /admin/blog/page.
export const legacyAdminBlogRedirectDisabled = true;
